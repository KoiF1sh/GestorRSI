<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="altaDepartamentos.aspx.cs" Inherits="GestorRSI.altaDepartamentos" %>
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Alta departamento<span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
