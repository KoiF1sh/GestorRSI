<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="consultarEmpleados.aspx.cs" Inherits="GestorRSI.consultarEmpleados" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="#">Consultar empleados<span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
        <div>
            <br />
        <div class="displayc">
            <h1>Empleados - Listado de registros</h1>
        </div>
        <div class="displayc">
            <div class="table small padding5 displayc">
                <asp:GridView runat="server" ID="gvEmpleados" class="table content-table table-borderless table-hover">
                    <Columns>
